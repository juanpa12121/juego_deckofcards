    ...
    <div className="container">
      <div className="mb-16 mt-36">
        ...
        <div className="sm:flex gap-10 text-justify">
          ...
          <p className="text-white text-3xl mb-8">Hay empate si ambos jugadores sacan cartas con numero o letra repetidas. Para desempatar, el que sume más puntos según la pinta gana.</p>
            <Link to="card-values" className='!mb-5 text-green-400 text-3xl hover:underline hover:text-orange-400'>Ver puntajes de las pintas</Link>
            <Outlet />
          </div>
        </div>
    </div>
